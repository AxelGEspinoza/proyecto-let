...
ggplot(ganados,aes(año,UC,color = Equipo[3])) + geom_line(lwd = 1) + 
  ...
  geom_text(aes(2013.95,5,label = "Inicio Torneos Cortos"),stat = "unique",color="386641")+
  geom_vline(xintercept = 2017, color = "386641",linetype = 2)+
  geom_text(aes(2016,5,label = "Fin Torneos Cortos"),stat = "unique",color="386641")+
  geom_text(aes(2017.95,5,label = "Inicio Torneo Largo"),stat = "unique",color="003566")+
