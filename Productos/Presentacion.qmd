...
```
Para realizar este proyecto se utilizo una base de informacion que se puede encontrar en Kaggle. 


Esta base de datos contiene la informacion de los resultados del futbol chileno entre los años 2008 y 2021 pero para efectos de la presentacion solo se utilizo la informacion entre los años 2009 y 2020.
...
podemos ver que todos los equipos estan parejos
...
La UC es el equipo con mejor rendimiento 