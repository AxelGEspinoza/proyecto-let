...
Ahora se generalizaremos los datos para los partidos ganados, empatados y perdidos del equipo Colo-Colo. Para esto se creo la siguiente tabla:
...
Ahora nos centraremos en ver el rendimiento general de Universidad de Chile, para esto se presenta la siguiente tabla:
